...
<div class="container-fluid text-center" style="padding-top:50px; padding-bottom:0px">
  <h1>Lo sentimos! El sistema para la bolsa de trabajo está en construcción.</h1>
<img src="img/construccion.png">
  <h2>Si necesita información, comuníquese con el Departamento de Bolsa de Trabajo.
        <br>
<h4>Contacto:<br>
Jefatura de Servicio Empresarial<br>
83294020 Ext. 5731<br>
bolsa.fime@uanl.mx<br></h4>
